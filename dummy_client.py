...
def delete_reset():
    print("DELETE http://127.0.0.1:8000/v1/reset\n")

    response = requests.delete("http://127.0.0.1:8000/v1/reset")
    print(response)

def post_package_retrieve(package_id):
    print("\nPOST http://127.0.0.1:8000/v1/package\n")
    ...
    response = requests.post("http://127.0.0.1:8000/v1/package", post_body)
    print(response)

def get_package_retrieve(package_id):
    print("\nGET http://127.0.0.1:8000/v1/package/\n")
    response = requests.get("http://127.0.0.1:8000/v1/package/" + package_id)
    print(response.content)

def delete_package(package_id):
    print("\nDELETE http://127.0.0.1:8000/v1/package/\n")
    response = requests.delete("http://127.0.0.1:8000/v1/package/" + package_id)
    print(response)
...
if __name__ == "__main__":
    ...
    delete_reset()
    post_package_retrieve(package_id)
    get_package_retrieve(package_id)
